...
function Youtube() {
	...
	useEffect(() => {
		fetch(
			...
			'https://www.googleapis.com/youtube/v3/search?key=AIzaSyDhBrQV3TxfCVLfF-UiMLR8Jqruis9oysc&channelId=UCE_M8A5yxnLfW0KghEeajjw&part=snippet,id&order=date&maxResults=6'
		)
